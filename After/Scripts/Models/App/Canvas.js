        ...
        (function (App) {
            class Canvas {
                ...
                CenterOnCoords(X, Y, ResetZoom, SmoothScroll) {
                    if (SmoothScroll) {
                        if (ResetZoom) {
                            var toX = (-X * 100 * After.Canvas.ZoomScale) + (After.Canvas.Element.width / 2) - 50;
                            var toY = (-Y * 100 * After.Canvas.ZoomScale) + (After.Canvas.Element.height / 2) - 50;
                            ...
                            var toX = (-X * 100) + (After.Canvas.Element.width / 2 / After.Canvas.ZoomScale) - (50);
                            var toY = (-Y * 100) + (After.Canvas.Element.height / 2 / After.Canvas.ZoomScale) - (50);
                            After.Utilities.Animate(After.Canvas, "OffsetX", After.Canvas.OffsetX, toX, 500);
                            After.Utilities.Animate(After.Canvas, "OffsetY", After.Canvas.OffsetY, toY, 500);
                        }
                    }
                        ...
                        if (ResetZoom) {
                            ...
                            After.Canvas.OffsetX = (-X * 100) + (After.Canvas.Element.width / 2 / After.Canvas.ZoomScale) - (50);
                            After.Canvas.OffsetY = (-Y * 100) + (After.Canvas.Element.height / 2 / After.Canvas.ZoomScale) - (50);
                        }
                        else {
                            After.Canvas.OffsetX = (-X * 100) + (After.Canvas.Element.width / 2 / After.Canvas.ZoomScale) - (50);
                            After.Canvas.OffsetY = (-Y * 100) + (After.Canvas.Element.height / 2 / After.Canvas.ZoomScale) - (50);

...
After.Temp.Login.Create = function () {
    var strUsername = $("#inputNewUsername").val() as string;
    var strPassword = $("#inputCreateNewPassword").val() as string;
    var strEmail = $("#inputEmail").val() as string;
    var strConfirmPassword = $("#inputCreateConfirmPassword").val() as string;
    ...
    if (strUsername.length > 25 || strPassword.length > 25) {
        $("#divCreateAccountStatus").hide();
